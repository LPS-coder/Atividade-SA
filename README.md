...
O **OMNIRAIL** é uma solução focada no monitoramento em tempo real de frotas ferroviárias[cite: 1, 2]. O sistema realiza a captura simulada de dados de sensores IoT (velocidade, localização, consumo de energia e falhas operacionais)[cite: 1, 2], permitindo a gestão centralizada da operação, manutenção preditiva e análise de desempenho[cite: 1, 2].

---

## 🚀 Tecnologias Utilizadas

* **Front-end:** HTML5, CSS3, JavaScript (ES6+), Bootstrap 5, Chart.js
* **Back-end:** PHP 8.x
